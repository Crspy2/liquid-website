...
import { BsFillArrowUpCircleFill, BsMouse } from 'react-icons/bs'
...
const Home = ({bannerData, products, incentiveData }: Props) => {
  ...
  return (
    <div className="bg-[#0F0E13]">
      ...
      <HideOn height={20}>
          <div className="sticky bottom-10 pl-20 w-full cursor-pointer">
            ...
            <svg  version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" width="17" height="26" viewBox="0, 0, 17, 26" 
                  className="h-6 w-6 rounded-full cursor-pointer mr-3 fill-gay-400">
              <g id="Page-1">
      ...
      <HideBetween height={true} startHeight={450} endHeight={2100} inverse={true}>
        <Link href="/">
