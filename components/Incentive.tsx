...
const Incentive = ({ incentiveInfo }: Props) => {
  ...
  return (
    <div className="bg-[#0F0E13] incentive-gradient">
      <div className="max-w-7xl mx-auto py-24 sm:px-2 sm:py-32 lg:px-4">
        <div className="max-w-2xl mx-auto px-4 lg:max-w-none">
          <div className="grid grid-cols-1 items-center gap-y-10 gap-x-16 lg:grid-cols-2">
            <div>
              <h2 className="text-5xl font-extrabold tracking-tight py-10 text-transparent bg-clip-text bg-gradient-to-r from-[#7928CA] to-[#FF0080] cursor-default">{incentive.title}</h2>
